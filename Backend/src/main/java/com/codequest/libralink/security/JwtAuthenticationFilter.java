...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
            ...
            if (jwtUtil.validateToken(token)) {
                ...
                if (user != null) {
                    ...
                    AuthenticatedUser principal = new AuthenticatedUser(
                            user.getId(), user.getEmail(), schoolIdOf(user), roleNames);

                    UsernamePasswordAuthenticationToken auth =
                            new UsernamePasswordAuthenticationToken(principal, user.getEmail(), authorities);
    ...
    private Integer schoolIdOf(User user) {
        return user.getInstitution() != null ? user.getInstitution().getInstitutionId() : null;
    }
